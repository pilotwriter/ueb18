...
public class Artikel {
  ...
  public Artikel(int artikelnr, String art, int bestand, double price) {
    ...
    if (bestand < 0) {
      throw new IllegalArgumentException("Bestand muss gr��er als 0 sein");
    }
    if (price <= 0) {
      throw new IllegalArgumentException("Preis muss gr��er als 0 sein");
    }
   ...
   *
   * @param menge Die Anzahl der Element die zum Bestand hinzugef�gt werden sollen
   * @throws IllegalArgumentException Wenn <code>menge</code> kleiner als 1 ist
   */
  public void bucheZugang(int menge) {
    if (menge < 1) {
      throw new IllegalArgumentException("Menge muss gr��er als 0 sein");
    }
    bestand += menge;
  }
  ...
  public void bucheAbgang(int menge) {
    ...
    if (bestand - menge < 0) {
      throw new IllegalArgumentException("Bestand muss nach Abgang gr��er 0 sein");
    }
    bestand -= menge;
  }
